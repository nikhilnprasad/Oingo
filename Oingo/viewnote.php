...
$getnotesresult = mysqli_query($db, "call GETNOTES('" . $uID . "')");
if ($getnotesresult) {
    mysqli_commit($db);
...
?>
<div class="content">
<p><strong>This note cannot be viewed by the user due to note, filters and location restrictions.</strong></p>
</div>
<?php
        } else {
...
<div class="content">
    <a href="createcomment.php?nid=<?php echo $noteid; ?>">Create comment</a>
</div>
                                <?php
...
<div class="content">
    ...
    <p><a href="createcomment.php?cid=<?php echo $notecid; ?>&nid=<?php echo $noteid; ?>">Reply</a> </p>
<?php
                                    mysqli_begin_transaction($db, MYSQLI_TRANS_START_READ_ONLY);
