...
<?php  if (isset($_SESSION['username'])) : ?>
    ...
    ?>
<form method="post" action="createcomment.php?nid=<?php echo $noteid; ?>&cid=<?php echo $cid; ?>" id="commentform">
    <div class="input-group">
        <input name="noteid" type="hidden" value="<?php echo $noteid; ?>">
        <input name="cid" type="hidden" value="<?php echo $cid; ?>">
        <textarea rows="4" cols="50" name="usercomment" form="commentform">Enter comment here...</textarea>
    </div>
    ...
    <div class="input-group">
        <button class="btn" type="submit" name="comment">Create Comment</button>
    </div>
</form>
